...
export default function LeftSidebar() {
    ...
    return (
        <div className='relative'>
            <div className='hidden sm:flex h-screen justify-between items-center flex-col border-r-2 border-neutral-800 w-28 bg-background py-5'>
                <aside className="flex flex-col items-center px-10 py-1 z-20">
                    <div className='block lg:hidden text-neutral-300 mb-4'><PanelRightOpen className='w-7 h-7' onClick={() => setIsRightPanelOpen(prev => !prev)} /></div>
            ...
            {isLeftPanelOpen && (
                <div className="overflow-y-scroll lg:hidden fixed inset-0 bg-black/50 z-20" onClick={() => setIsLeftPanelOpen(false)}>
                    <div className='h-screen justify-between items-center flex-col border-r-2 border-neutral-800 w-28 bg-background py-5'>
                        <aside
                            className="justify-start items-center h-full w-28 bg-background border-r-2 border-neutral-800 flex flex-col py-5 overflow-y-auto"
                        ...
                        >
                            ...
                            <div className='absolute bottom-2 bg-background w-28 border-r-2 border-neutral-800 py-3'>
                                {session?.user.image && <Image src={session?.user.image} width={100} height={100} alt='user image' className='ml-7 rounded-full w-12 h-12 cursor-pointer' onClick={() => setIsOpen(prev => !prev)} />}
                            </div>
                        </aside>
                    </div>
                </div>
