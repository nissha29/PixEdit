      ...
      <div className="space-y-4 flex flex-col gap-7">
          ...
          {tools.map((toolItem) => (
            <button
              ...
              className={`p-3 rounded-lg transition-all duration-200 flex flex-col items-center gap-1.5 text-sm ${tool === toolItem.id
                ? 'bg-fuchsia-500 text-white hover:cursor-pointer'
        ...
        <div>
          ...
          <input
            ...
            "
            style={{
              background: `linear-gradient(to right, #d946ef 0%, #d946ef ${((brushSize - 1) / (20 - 1)) * 100}%, #e5e7eb ${((brushSize - 1) / (20 - 1)) * 100}%, #e5e7eb 100%)`
            }}
          />
