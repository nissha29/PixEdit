...
const content = [
    {
        ...
        content: (
            <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] text-neutral-800">
                Create Your Account
            </div>
        ),
    },
...
export default function HowItWorks() {
    return <div className="text-5xl mb-32 bg-neutral-900 p-10 mt-10 flex justify-center items-center flex-col">
        ...
        <div className='text-lg text-neutral-400 flex-wrap w-2xl text-center mt-7'>Experience the ease of editing with powerful tools designed to help you create stunning images in just minutes.</div>
