...
function Video() {
    return (
        <div className='flex flex-col justify-center items-center mb-32'>
            <div className="w-full mt-2 overflow-hidden h-1/2 shadow-2xl shadow-accent-dark/30 hover:shadow-accent-dark/40 border border-neutral-700 rounded translate-10 rotate-3">
                <div className="relative z-10 group hover:cursor-pointer">
                    <Image src='/lp-pix.png' width={2000} height={2000} className='w-full h-[52rem]' alt='' />
